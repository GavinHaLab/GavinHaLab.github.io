...
```
See the [ichorCNA](https://github.com/gavinha/TitanCNA/tree/master/scripts/snakemake/https://github.com/broadinstitute/ichorCNA/blob/master/scripts/runIchorCNA.R) repo for the ichorCNA R script.
