---
layout: project
title: SV_WGS_analysis/
project: SV_WGS_analysis
repo: GavinHaLab/SV_WGS_analysis
...
- `cytobandFile` is used for plotting the chromosome idiograms and only needs to specify [data/cytoBand_hg38.txt](https://github.com/GavinHaLab/SV_WGS_analysis/tree/master/data/cytoBand_hg38.txt) if using hg38.
